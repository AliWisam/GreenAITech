...
contract Plestaking is Ownable {
    ...
    // ple token contract address
    address public constant tokenAddress = 0xC18408E75977816F4338f79aB7BEe005D140A6b0;
    ...
    // Admin cannot transfer out PLE from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out PLE!");
        Token(_tokenAddr).transfer(_to, _amount);
    }

    /** 
     * @notice A simple method that calculates the rewards for each stakeholder.
     * @param _holder The stakeholder to calculate rewards for.
     */
    function calculateReward(address _holder)
        public
        view
        returns(uint256)
    {   
        ...
        depositedTokens[_holder] .mul(rewardRate)
                                     .mul(timeDiff)
                                     .div(rewardInterval)
                                     .div(1e4);
    }
